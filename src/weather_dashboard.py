...
class WeatherDashboard:
    ...
    def list_weather_files(self):
        """List all weather data files stored in S3"""
        try:
            response = self.s3_client.list_objects_v2(Bucket=self.bucket_name, Prefix="weather-data/")
...
def main():
    ...
    cities = ["Chicago", "Indianpolis", "San Diego", "Abu Dhabi"]
